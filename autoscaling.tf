...
resource "aws_appautoscaling_target" "table_read" {
  ...
  resource_id        = "table/${aws_dynamodb_table.default[0].name}"
  role_arn           = aws_iam_service_linked_role.dynamodb_autoscaling[0].arn
...
resource "aws_appautoscaling_policy" "table_read_policy" {
  ...
  name               = "${aws_appautoscaling_target.table_read[0].resource_id}ReadScalingPolicy"
...
resource "aws_appautoscaling_policy" "table_write_policy" {
  ...
  name               = "${aws_appautoscaling_target.table_write[0].resource_id}WriteScalingPolicy"
  policy_type        = "TargetTrackingScaling"
...
resource "aws_appautoscaling_target" "index_read" {
  ...
  resource_id        = "table/${aws_dynamodb_table.default[0].name}/index/${each.key}"
  role_arn           = aws_iam_service_linked_role.dynamodb_autoscaling[0].arn
...
resource "aws_appautoscaling_policy" "index_read_policy" {
  ...
  name               = "${aws_appautoscaling_target.index_read[each.key].resource_id}ReadScalingPolicy"
  policy_type        = "TargetTrackingScaling"
...
resource "aws_appautoscaling_policy" "index_write_policy" {
  ...
  name               = "${aws_appautoscaling_target.index_write[each.key].resource_id}WriteScalingPolicy"
  policy_type        = "TargetTrackingScaling"
